...
import { 
  LayoutDashboard, Package, DollarSign, History, 
...
const menuItems = [
  ...
  { title: 'Orders', href: '/rider/orders', icon: Package },
  { title: 'Earnings', href: '/rider/earnings', icon: DollarSign },
        ...
        <div className="flex flex-col h-full">
          <div className="flex items-center gap-3 p-6 border-b border-gray-200">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">Rider Panel</p>
            </div>
          </div>
